      ...
      <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                >
                  <i
                    :class="
                      metric.trend > 0 ? 'pi pi-arrow-up' : 'pi pi-arrow-down'
                    "
                  ></i>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          <div class="flex items-center justify-between mb-2">
            <h2
              class="text-2xl font-bold text-blue-900 flex items-center gap-2"
            >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between mb-1">
                ...
                <div
                  class="inline-flex rounded-lg border mb-4 border-gray-200 p-1"
                >
                  <button
              ...
              >
                <div class="flex flex-wrap gap-2">
                  <span
                    v-for="word in wordCloudView === 'positive'
                      ? positiveWords
                      : negativeWords"
                    :key="word.text"
        ...
        >
          <div class="flex items-center justify-between mb-2">
            <h2
              class="text-2xl font-bold text-green-900 flex items-center gap-2"
            >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div class="h-64 bg-gray-50 rounded-lg p-2">
                <svg class="w-full h-full" viewBox="0 0 400 250">
                  ...
                  <text
                    ...
                    :key="index"
                    :x="
                      40 + (index * 320) / (currentPerformanceData.length - 1)
                    "
                    y="230"
                    text-anchor="middle"
            ...
            <!-- Review Sources -->
            <div>
              <h2 class="text-base font-bold text-center text-green-900 mb-6">
                Review Sources
              </h2>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          >
            <h2
              class="text-2xl font-bold text-purple-900 flex items-center gap-2 mb-2"
            >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-14 mb-10">
            ...
            <div>
              <h4 class="text-base font-semibold text-purple-900 mb-4">
                Average Rating (Past 3 Months)
              </h4>
                ...
                <table class="w-full border-collapse">
                  <thead>
                    <tr class="bg-gray-100">
                      <th
                        class="text-left text-sm font-semibold text-gray-700 p-3 border border-gray-200"
                      >
                        Month
                      </th>
                      <th
                        class="text-center text-sm font-semibold text-gray-700 p-3 border border-gray-200"
                      >
                        Your Business
                      </th>
                      <th
                        class="text-center text-sm font-semibold text-gray-700 p-3 border border-gray-200"
                      >
                        {{ currentCompetitor?.name || "Competitor" }}
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    >
                      <td
                        class="text-sm font-medium text-gray-700 p-3 border border-gray-200"
                      >
                        {{ month.month }}
                      </td>
                      <td class="text-center p-3 border border-gray-200">
                        <div class="flex items-center justify-center gap-2">
                          <span class="text-lg font-bold text-[#008253]">{{
                            month.rating
                          }}</span>
                          <i
                            :class="[
                      ...
                      <td class="text-center p-3 border border-gray-200">
                        <div class="flex items-center justify-center gap-2">
                          <span class="text-lg font-bold text-gray-700">{{
                            currentCompetitorMonthlyTrend[index]?.rating ||
                            "N/A"
                          }}</span>
                          <i
                            :class="[
                              'pi text-xs',
                              (currentCompetitorMonthlyTrend[index]?.change ||
                                0) > 0
                                ? 'pi-arrow-up text-green-600'
                                : (currentCompetitorMonthlyTrend[index]
                                      ?.change || 0) < 0
                                  ? 'pi-arrow-down text-red-600'
                                  : 'pi-minus text-gray-400',
                            ]"
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <h4 class="text-base font-semibold text-purple-900">
                  Competitor Keywords
                </h4>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <span
                    class="inline-block mt-2 text-xs font-medium text-green-700 bg-green-200 px-2 py-1 rounded"
                  >
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div class="flex items-center justify-between mb-6">
              <h3
                class="text-2xl font-bold text-orange-900 flex items-center gap-2"
              >
            ...
            <div class="space-y-4">
              ...
              >
                <div
                  class="flex-shrink-0 w-8 h-8 bg-orange-600 rounded-full flex items-center justify-center"
                >
                  <i class="pi pi-times text-white text-xs"></i>
                </div>
                <div>
                  <h4 class="text-base font-semibold text-orange-900">
                    {{ issue.title }}
                  </h4>
                  ...
                  <span
                    class="inline-block mt-2 text-xs font-medium text-orange-700 bg-orange-200 px-2 py-1 rounded"
                  >
...
const currentPerformanceData = computed(() => {
  const dataset =
    selectedChartType.value === "ratings"
      ? performanceDataSets.ratings
      : performanceDataSets.volume;
