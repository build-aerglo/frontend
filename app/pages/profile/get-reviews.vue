  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-6">
        <h2 class="text-4xl font-bold text-gray-900 mb-3">Get More Reviews</h2>
        <p class="text-lg text-gray-600">Share your review link and QR code to collect customer feedback</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="flex flex-col justify-center space-y-4">
            ...
            <p class="text-gray-600 text-sm mb-4">Download or print your QR code to display at your business location</p>
