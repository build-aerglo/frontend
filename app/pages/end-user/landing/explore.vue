                ...
                <div class="flex flex-col gap-1">
                  <div class="relative w-24 h-24"> 
                    <div class="w-full h-full bg-white rounded-full flex items-center justify-center border-2 border-slate-200 overflow-hidden">
                      <img :src="('logo' in business && business.logo) ? String(business.logo) : 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=200&h=200&auto=format&fit=crop'" class="w-full h-full object-cover" />
                    </div>
