<template>
  <div class="min-h-screen bg-green-100 bg-cover bg-center flex items-center justify-center">
    <div class="relative w-full max-w-md px-6 py-8 bg-white/90 backdrop-blur rounded-2xl shadow-lg">
      ...
      <form @submit.prevent="onSubmit" class="space-y-4">
        ...
        <div>
          ...
          <input id="phone" v-model="phone" type="tel" pattern="[0-9]{11}"
            class="border border-light-300 hover:border-light-400 focus:border-primary focus:ring-2 focus:ring-primary outline-none rounded-md p-2 w-full transition" />
        </div>
        ...
        <div class="flex gap-3">
          <div class="relative w-1/2">
            ...
            <InputTextCustom v-model="password" :type="showPassword ? 'text' : 'password'"
            ...
            <i :class="showPassword ? 'pi pi-eye' : 'pi pi-eye-slash'"
              class="absolute right-3 top-9 cursor-pointer text-gray-400" @click="togglePassword"></i>
          </div>
          ...
          <div class="relative w-1/2">
            ...
            <InputTextCustom v-model="confirmPassword" :type="showConfirm ? 'text' : 'password'"
              inputClass="border border-light-300 hover:border-light-400 focus:border-primary focus:ring-2 focus:ring-primary outline-none rounded-md p-2 w-full transition" />
            <i :class="showConfirm ? 'pi pi-eye' : 'pi pi-eye-slash'"
              class="absolute right-3 top-9 cursor-pointer text-gray-400" @click="toggleConfirm"></i>
          </div>
        </div>
      ...
      <p class="text-center text-sm mt-5">
        ...
        <NuxtLink to="/auth/support-user/sign-in" class="text-blue-500 hover:underline">
          Sign in
        </NuxtLink>
      </p>
    </div>
