<template>
  <div class="flex flex-col items-center pointer-events-none">
    ...
    <div class="relative w-full">
      ...
      >
        ...
        <text
          ...
          style="pointer-events: none; user-select: none; text-transform: lowercase; letter-spacing: -0.5px;"
        >
          {{ statusLabel }}
        </text>
      </svg>
    ...
    <!-- Claim Status Text -->
    <div 
      class="text-xs font-medium px-2 py-0.5 rounded-sm whitespace-nowrap"
